class BreweriesController < ApplicationController
  ...
  before_action :authenticate, :authenticate, only: [:destroy]
  ...
  private
    ...
    def authenticate
      ...
      authenticate_or_request_with_http_basic do |username, password|
        raise "Wrong username or password" unless admin_accounts.key?(username) and admin_accounts.has_value?(password)
